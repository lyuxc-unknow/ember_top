...
public class Reactor {
    public static class ember implements IWailaDataProvider {
        ...
        public List<String> getWailaBody(ItemStack stack, List<String> currenttip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
            ...
            double ember = ((TileEntityReactor) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmber();
            double maxember = ((TileEntityReactor) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmberCapacity();
