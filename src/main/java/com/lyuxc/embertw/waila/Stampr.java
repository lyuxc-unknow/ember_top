...
public class Stampr {
    public static class ember implements IWailaDataProvider {
        ...
        public List<String> getWailaBody(ItemStack stack, List<String> currenttip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
            ...
            double ember = ((TileEntityStamper) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmber();
            double maxember = ((TileEntityStamper) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmberCapacity();
