...
public class EmberFunnel {
    public static class ember implements IWailaDataProvider {
        ...
        public List<String> getWailaBody(ItemStack itemStack, List<String> tips, IWailaDataAccessor wailaDataAccessor, IWailaConfigHandler wailaConfigHandler) {
            ...
            double ember = ((TileEntityEmberFunnel) Objects.requireNonNull(wailaDataAccessor.getTileEntity())).capability.getEmber();
            double maxember = ((TileEntityEmberFunnel) Objects.requireNonNull(wailaDataAccessor.getTileEntity())).capability.getEmberCapacity();
