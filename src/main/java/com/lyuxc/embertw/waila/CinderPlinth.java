...
public class CinderPlinth {
    public static class ember implements IWailaDataProvider {
        ...
        public List<String> getWailaBody(ItemStack stack, List<String> currenttip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
            ...
            double ember = ((TileEntityCinderPlinth) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmber();
            double maxember = ((TileEntityCinderPlinth) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmberCapacity();
