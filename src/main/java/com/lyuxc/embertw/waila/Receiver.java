...
public class Receiver {
    public static class ember implements IWailaDataProvider {
        ...
        public List<String> getWailaBody(ItemStack stack, List<String> currenttip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
            ...
            double ember = ((TileEntityReceiver) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmber();
            double maxember = ((TileEntityReceiver) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmberCapacity();
