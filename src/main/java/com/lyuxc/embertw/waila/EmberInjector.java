...
public class EmberInjector {
    public static class ember implements IWailaDataProvider {
        ...
        public List<String> getWailaBody(ItemStack stack, List<String> currenttip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
            ...
            double ember = ((TileEntityEmberInjector) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmber();
            double maxember = ((TileEntityEmberInjector) Objects.requireNonNull(accessor.getTileEntity())).capability.getEmberCapacity();
