...
public class CrystalCell {
    public static class ember implements IWailaDataProvider {
        ...
        public List<String> getWailaBody(ItemStack itemStack, List<String> tips, IWailaDataAccessor wailaDataAccessor, IWailaConfigHandler wailaConfigHandler) {
            ...
            double ember = ((TileEntityCrystalCell) Objects.requireNonNull(wailaDataAccessor.getTileEntity())).capability.getEmber();
            double maxember = ((TileEntityCrystalCell) Objects.requireNonNull(wailaDataAccessor.getTileEntity())).capability.getEmberCapacity();
